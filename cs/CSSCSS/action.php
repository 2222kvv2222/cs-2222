...
if($_POST["server"] === "") {unset($_POST["server"]);} else {$server = $_POST["server"];}

if(isset($nick) and isset($prichina) and isset($dok) and isset($contacts) and isset($date) and isset($ip)) {

$strSQL = "INSERT INTO unban (nick,contacts,prichina,dok,ip,date) VALUES ('$nick','$contacts','$prichina','$dok','$ip','$server','$date')"; 
