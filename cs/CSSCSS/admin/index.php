...
<? } ?>
	  <li class="dropdown">
        ...
        <ul class="dropdown-menu">
		  ...
		  <li class="divider"></li>
          <li><a href="./?go=news">Управление новостями</a></li>
		  <li class="divider"></li>
		  <li><a href="./?go=ban_ip">Управление IP Банов</a></li>
		  <li class="divider"></li>
		  <li><a href="./?go=server">Управление серверами</a></li>
		  <li class="divider"></li>
		  <li><a href="./?go=complaints">Управление жалобами</a></li>
        </ul>
      </li>
...
<div style=" <? if(!isset($_GET['go']))
 ...
 if($_GET['go'] === 'server') {if(isset($_GET['view'])) {echo 'width: 450px;';}if(isset($_GET['add'])) {echo 'width: 450px;';}}
 if($_GET['go'] === 'complaints') {if(isset($_GET['view'])) {echo 'width: 450px;';}}
...
<?
  ...
  if ($_GET['go'] === "complaints") {
  include('includes/_complaints.php');
  }
?>
</div>
